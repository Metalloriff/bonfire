...
#  Load Part                                                 #
#  ─────────                                                 #
#                  ┌───────┐ YAML__Token  ┌──────┐    YAML__Event        #
#  String  ───────►│YAML__Scanner│───────►│YAML__Parser│──────────────┐  #
#                  └───────┘        └──────┘              │  #
#                                          ┌──────────┐   │  #
#                 ┌───────────┐  YAML__YAMLNode  │ YAML__Composer │   │  #
#  Variant ◄──────│YAML__Constructor│◄────────── │┌────────┐│◄──┘  #
#                 └───────────┘            ││YAML__Resolver││      #
#                                          │└────────┘│      #
#                                          └──────────┘      #
#                                                            #
...
#  ───────────                             │ YAML__Serializer │  #
#                  ┌───────────┐ YAML__YAMLNode  │┌──────────┐│  #
#   Variant ──────►│YAML__Representer│──────────►││ YAML__Resolver ││  #
#                  └───────────┘           │└──────────┘│  #
#                                          └────────────┘  #
#                                                 │        #
#                              ┌───────┐  YAML__Event   │        #
#   String ◄───────────────────│YAML__Emitter│◄─────────┘        #
#                              └───────┘                   #
#                                                          #
############################################################
